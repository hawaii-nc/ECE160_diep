...
def reset_game():
    ...
    return player, bullets, bots, frame_count, game_over, difficulty_level, show_specialization_menu, bot_id_counter, walls
...
def main():
    ...
    player, bullets, bots, frame_count, game_over, difficulty_level, show_specialization_menu, bot_id_counter, walls = reset_game()
