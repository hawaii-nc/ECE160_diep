...
class Tank:
    ...
    def draw(self, win, cam_x, cam_y, aim_angle):
        ...
        for mount in self.gun_mounts:
            ...
            # If shotgun modifier is active, render a triangular cone barrel
            if self.is_shotgun:
                # Triangle with tip at the tank and base facing away.
                # Use a 60 degree cone (30° each side).
                half_angle = math.pi / 6.0  # 30 degrees
                # lateral half-width of the base at distance 'length'
